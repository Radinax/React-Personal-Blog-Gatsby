...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-e0ae62df2bb090cb0cd5.js"
  },
  {
    "url": "app-4e11346c8e77271929a6.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "97a2349bc4feabbbed88957c55e9b3ce"
  },
  {
    "url": "0-536b63d17895bdbe58d7.js"
  },
  {
    "url": "component---src-pages-404-js-12d1e7628384a501a7eb.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "0c4d20f878d001fa2ac43473bdf9b791"
  }
...
var navigationRoute = new workbox.routing.NavigationRoute(function (_ref) {
  ...
  return idbKeyval.get(WHITELIST_KEY).then(function (customWhitelist) {
    ...
    if (customWhitelist.includes(pathname)) {
      var offlineShell = "/React-Personal-Blog-Gatsby/offline-plugin-app-shell-fallback/index.html";
...
var messageApi = {
  whitelistPathnames: function whitelistPathnames(event) {
    ...
    pathnames = pathnames.map(function (_ref3) {
      ...
      if (!includesPrefix) {
        return "/React-Personal-Blog-Gatsby" + pathname;
      } else {
        return pathname;
      }
    });
